...
function ServerComputePassiveBonuses()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		for (i = 0; i < MyWMPRI.Purchase_PerkUpgrade.Length; ++i)
		{
			...
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyDamageGivenPassive(PassiveDamageGiven, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyDamageTakenPassive(PassiveDamageTaken, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyHealAmountPassive(PassiveHealAmount, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyHardAttackDamagePassive(PassiveHardAttackDamage, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyStunPowerPassive(PassiveStunPower, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyStumblePowerPassive(PassiveStumblePower, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyKnockdownPowerPassive(PassiveKnockdownPower, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifySnarePowerPassive(PassiveSnarePower, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_SkillUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyDamageGivenPassive(PassiveDamageGiven, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyDamageTakenPassive(PassiveDamageTaken, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyHealAmountPassive(PassiveHealAmount, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyHardAttackDamagePassive(PassiveHardAttackDamage, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyStunPowerPassive(PassiveStunPower, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyStumblePowerPassive(PassiveStumblePower, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyKnockdownPowerPassive(PassiveKnockdownPower, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifySnarePowerPassive(PassiveSnarePower, MyWMPRI.GetSkillUpgrade(index));
		}
...
simulated function ClientAndServerComputePassiveBonuses()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifySpeedPassive(PassiveMovementSpeed, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyWeaponSwitchTimePassive(PassiveSwitchSpeed, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyMeleeAttackSpeedPassive(PassiveMeleeAttackSpeed, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetReloadRateScalePassive(PassiveReloadRateScale, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyRecoilPassive(PassiveRecoil, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifySpreadPassive(PassiveSpread, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyWeaponBopDampingPassive(PassiveBobDamp, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyMagSizeAndNumberPassive(PassiveMagazineCapacity, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifySpareAmmoAmountPassive(PassiveSpareAmmo, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyRateOfFirePassive(PassiveRateOfFire, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyTightChokePassive(PassiveTightChoke, MyWMPRI.bPerkUpgrade[index].level);
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyPenetrationPassive(PassivePenetration, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_SkillUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifySpeedPassive(PassiveMovementSpeed, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyWeaponSwitchTimePassive(PassiveSwitchSpeed, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyMeleeAttackSpeedPassive(PassiveMeleeAttackSpeed, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetReloadRateScalePassive(PassiveReloadRateScale, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyRecoilPassive(PassiveRecoil, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifySpreadPassive(PassiveSpread, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyWeaponBopDampingPassive(PassiveBobDamp, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyMagSizeAndNumberPassive(PassiveMagazineCapacity, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifySpareAmmoAmountPassive(PassiveSpareAmmo, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyRateOfFirePassive(PassiveRateOfFire, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyTightChokePassive(PassiveTightChoke, MyWMPRI.GetSkillUpgrade(index));
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyPenetrationPassive(PassivePenetration, MyWMPRI.GetSkillUpgrade(index));
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
...
function ModifyDamageGiven(out int InDamage, optional Actor DamageCauser, optional KFPawn_Monster MyKFPM, optional KFPlayerController DamageInstigator, optional class<KFDamageType> DamageType, optional int HitZoneIdx)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyDamageGiven(InDamage, DefaultDamage, MyWMPRI.bPerkUpgrade[index].level, DamageCauser, MyKFPM, DamageInstigator, DamageType, HitZoneIdx, MyKFW);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyDamageGiven(InDamage, DefaultDamage, MyWMPRI.GetSkillUpgrade(index), DamageCauser, MyKFPM, DamageInstigator, DamageType, HitZoneIdx, MyKFW);
		}
	}
...
function ModifyHardAttackDamage(out int InDamage)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyHardAttackDamage(InDamage, DefaultDamage, MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyHardAttackDamage(InDamage, DefaultDamage, MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
		}
	}
...
function ModifyDamageTaken(out int InDamage, optional class<DamageType> DamageType, optional Controller InstigatedBy)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyDamageTaken(InDamage, DefaultDamage, MyWMPRI.bPerkUpgrade[index].level, OwnerPawn, DamageType, InstigatedBy, MyKFW);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyDamageTaken(InDamage, DefaultDamage, MyWMPRI.GetSkillUpgrade(index), OwnerPawn, DamageType, InstigatedBy, MyKFW);
		}
	}
...
function ModifyHealth(out int InHealth)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyHealth(InHealth, DefaultHealth, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyHealth(InHealth, DefaultHealth, MyWMPRI.GetSkillUpgrade(index));
		}
	}
}
...
function ModifyArmorInt(out int MaxArmor)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyArmor(MaxArmor, DefaultArmor, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyArmor(MaxArmor, DefaultArmor, MyWMPRI.GetSkillUpgrade(index));
		}
	}
}
...
simulated function ModifyMeleeAttackSpeed(out float InDuration, KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyMeleeAttackSpeed(InDuration, DefaultDuration, MyWMPRI.bPerkUpgrade[index].level, KFW);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyMeleeAttackSpeed(InDuration, DefaultDuration, MyWMPRI.GetSkillUpgrade(index), KFW);
		}
	}
...
simulated function float GetReloadRateScale(KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetReloadRateScale(InReloadRateScale, MyWMPRI.bPerkUpgrade[index].level, KFW, OwnerPawn);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetReloadRateScale(InReloadRateScale, MyWMPRI.GetSkillUpgrade(index), KFW, OwnerPawn);
		}
	}
...
function bool ModifyHealAmount(out float HealAmount)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyHealAmount(HealAmount, DefaultHealAmount, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyHealAmount(HealAmount, DefaultHealAmount, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
simulated function ModifyHealerRechargeTime(out float RechargeRate)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyHealerRechargeTime(RechargeRate, DefaultRechargeRate, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyHealerRechargeTime(RechargeRate, DefaultRechargeRate, MyWMPRI.GetSkillUpgrade(index));
		}
	}
}
...
simulated function ModifySpeed(out float Speed)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifySpeed(Speed, DefaultSpeed, MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifySpeed(Speed, DefaultSpeed, MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
		}
	}
}
...
simulated function ModifyRecoil(out float CurrentRecoilModifier, KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyRecoil(CurrentRecoilModifier, DefaultRecoilModifier, MyWMPRI.bPerkUpgrade[index].level, KFW);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyRecoil(CurrentRecoilModifier, DefaultRecoilModifier, MyWMPRI.GetSkillUpgrade(index), KFW);
		}
	}
...
simulated function ModifySpread(out float InSpread)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifySpread(InSpread, DefaultSpreadModifier, MyWMPRI.bPerkUpgrade[index].level, KFW);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifySpread(InSpread, DefaultSpreadModifier, MyWMPRI.GetSkillUpgrade(index), KFW);
		}
	}
...
simulated function ModifyWeaponBopDamping(out float BobDamping, KFWeapon PawnWeapon)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyWeaponBopDamping(InBobDamping, DefaultBobDamping, MyWMPRI.bPerkUpgrade[index].level, PawnWeapon);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyWeaponBopDamping(InBobDamping, DefaultBobDamping, MyWMPRI.GetSkillUpgrade(index), PawnWeapon);
		}
	}
...
simulated function ModifyMagSizeAndNumber(KFWeapon KFW, out int MagazineCapacity, optional array< class<KFPerk> > WeaponPerkClass, optional bool bSecondary = False, optional name WeaponClassname)
{
	...
	if (MyWMPRI != None && MyWMGRI != None && KFWeap_Healer_Syringe(KFW) == None && KFWeap_Welder(KFW) == None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyMagSizeAndNumber(MagCapacity, DefaultMagazineCapacity, MyWMPRI.bPerkUpgrade[index].level, KFW, WeaponPerkClass, bSecondary, WeaponClassname);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyMagSizeAndNumber(MagCapacity, DefaultMagazineCapacity, MyWMPRI.GetSkillUpgrade(index), KFW, WeaponPerkClass, bSecondary, WeaponClassname);
		}
	}
...
simulated function ModifySpareAmmoAmount(KFWeapon KFW, out int PrimarySpareAmmo, optional const out STraderItem TraderItem, optional bool bSecondary = False)
{
	...
	if (KFW != None && PrimarySpareAmmo > 0)
	{
		...
		if (MyWMPRI != None && MyWMGRI != None)
		{
			...
			{
				index = MyWMPRI.Purchase_PerkUpgrade[i];
				MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifySpareAmmoAmount(PrimarySpareAmmo, DefaultSpareAmmo, MyWMPRI.bPerkUpgrade[index].level, KFW, TraderItem, bSecondary);
			}
			for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
			{
				index = MyWMPRI.Purchase_EquipmentUpgrade[i];
			...
			{
				index = MyWMPRI.Purchase_SkillUpgrade[i];
				MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifySpareAmmoAmount(PrimarySpareAmmo, DefaultSpareAmmo, MyWMPRI.GetSkillUpgrade(index), KFW, TraderItem, bSecondary);
			}
		}
...
simulated function ModifyMaxSpareGrenadeAmount()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifySpareGrenadeAmount(SpareGrenade, DefaultSpareGrenade, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifySpareGrenadeAmount(SpareGrenade, DefaultSpareGrenade, MyWMPRI.GetSkillUpgrade(index));
		}
...
simulated function ModifyWeldingRate(out float FastenRate, out float UnfastenRate)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyWeldingRate(FastenRate, DefaultFastenRate, UnfastenRate, DefaultUnfastenRate, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyWeldingRate(FastenRate, DefaultFastenRate, UnfastenRate, DefaultUnfastenRate, MyWMPRI.GetSkillUpgrade(index));
		}
	}
}
...
function float GetZedTimeExtensionMax(byte Level)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetZedTimeExtension(Extension, DefaultExtension, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetZedTimeExtension(Extension, DefaultExtension, MyWMPRI.GetSkillUpgrade(index));
		}
	}
	...
	if (CheckOwnerPawn())
	{
		...
		if (KFIM != None)
		{
			...
			if (MyWMPRI != None && MyWMGRI != None)
			{
				...
				{
					index = MyWMPRI.Purchase_PerkUpgrade[i];
					MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ApplyWeightLimits(InWeightLimit, DefaultWeightLimit, MyWMPRI.bPerkUpgrade[index].level);
				}
				for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
				{
					index = MyWMPRI.Purchase_EquipmentUpgrade[i];
				...
				{
					index = MyWMPRI.Purchase_SkillUpgrade[i];
					MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ApplyWeightLimits(InWeightLimit, DefaultWeightLimit, MyWMPRI.GetSkillUpgrade(index));
				}
			}
...
function ModifyDoTScaler(out float DoTScaler, optional class<KFDamageType> KFDT, optional bool bNapalmInfected)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyDoTScaler(DotScaler, DefaultDoTScaler, MyWMPRI.bPerkUpgrade[index].level, KFDT, bNapalmInfected);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyDoTScaler(DotScaler, DefaultDoTScaler, MyWMPRI.GetSkillUpgrade(index), KFDT, bNapalmInfected);
		}
	}
}
...
simulated function ModifyRateOfFire(out float InRate, KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyRateOfFire(InRate, DefaultRate, MyWMPRI.bPerkUpgrade[index].level, KFW);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyRateOfFire(InRate, DefaultRate, MyWMPRI.GetSkillUpgrade(index), KFW);
		}
	}
...
simulated function float GetTightChokeModifier()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyTightChoke(InTight, DefaultTight, MyWMPRI.bPerkUpgrade[index].level, KFW, OwnerPawn);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyTightChoke(InTight, DefaultTight, MyWMPRI.GetSkillUpgrade(index), KFW, OwnerPawn);
		}
	}
...
simulated function float GetPenetrationModifier(byte Level, class<KFDamageType> DamageType, optional bool bForce)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyPenetration(InPenetration, DefaultPenetration, MyWMPRI.bPerkUpgrade[index].level, DamageType, OwnerPawn, bForce);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyPenetration(InPenetration, DefaultPenetration, MyWMPRI.GetSkillUpgrade(index), DamageType, OwnerPawn, bForce);
		}
	}
...
function float GetStunPowerModifier(optional class<DamageType> DamageType, optional byte HitZoneIdx)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyStunPower(InStunPower, DefaultStunPower, MyWMPRI.bPerkUpgrade[index].level, DamageType, HitZoneIdx);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyStunPower(InStunPower, DefaultStunPower, MyWMPRI.GetSkillUpgrade(index), DamageType, HitZoneIdx);
		}
	}
...
function float GetStumblePowerModifier(optional KFPawn KFP, optional class<KFDamageType> DamageType, optional out float CooldownModifier, optional byte BodyPart)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyStumblePower(InStumblePower, DefaultStumblePower, MyWMPRI.bPerkUpgrade[index].level, KFP, DamageType, CooldownModifier, BodyPart, OwnerPawn);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyStumblePower(InStumblePower, DefaultStumblePower, MyWMPRI.GetSkillUpgrade(index), KFP, DamageType, CooldownModifier, BodyPart, OwnerPawn);
		}
	}
...
function float GetKnockdownPowerModifier(optional class<DamageType> DamageType, optional byte BodyPart, optional bool bIsSprinting = False)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyKnockdownPower(InKnockdownPower, DefaultKnockdownPower, MyWMPRI.bPerkUpgrade[index].level, OwnerPawn, DamageType, BodyPart, bIsSprinting);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyKnockdownPower(InKnockdownPower, DefaultKnockdownPower, MyWMPRI.GetSkillUpgrade(index), OwnerPawn, DamageType, BodyPart, bIsSprinting);
		}
	}
...
simulated function float GetSnarePowerModifier(optional class<DamageType> DamageType, optional byte HitZoneIdx)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifySnarePower(InSnarePower, DefaultSnarePower, MyWMPRI.bPerkUpgrade[index].level, DamageType, HitZoneIdx);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifySnarePower(InSnarePower, DefaultSnarePower, MyWMPRI.GetSkillUpgrade(index), DamageType, HitZoneIdx);
		}
	}
...
simulated function ModifyWeaponSwitchTime(out float ModifiedSwitchTime)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyWeaponSwitchTime(ModifiedSwitchTime, DefaultSwitchTime, MyWMPRI.bPerkUpgrade[index].level, KFW);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyWeaponSwitchTime(ModifiedSwitchTime, DefaultSwitchTime, MyWMPRI.GetSkillUpgrade(index), KFW);
		}
	}
}
...
function AddVampireHealth(KFPlayerController KFPC, class<DamageType> DT)
{
	...
	if (KFPC.Pawn != None)
	{
		...
		if (MyWMPRI != None && MyWMGRI != None)
		{
			...
			{
				index = MyWMPRI.Purchase_PerkUpgrade[i];
				MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.AddVampireHealth(InHealth, DefaultHealth, MyWMPRI.bPerkUpgrade[index].level, KFPC, DT);
			}
			for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
			{
				index = MyWMPRI.Purchase_EquipmentUpgrade[i];
			...
			{
				index = MyWMPRI.Purchase_SkillUpgrade[i];
				MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.AddVampireHealth(InHealth, DefaultHealth, MyWMPRI.GetSkillUpgrade(index), KFPC, DT);
			}
		}
...
function bool CanSpreadNapalm()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bCanSpreadNapalm = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.CanSpreadNapalm(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bCanSpreadNapalm)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bCanSpreadNapalm = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.CanSpreadNapalm(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bCanSpreadNapalm)
				return True;
		}
	}
...
simulated function bool CanKnockDownOnBump(KFPawn_Monster KFPM)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bCanKnockDown = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ShouldKnockDownOnBump(MyWMPRI.bPerkUpgrade[index].level, KFPM, OwnerPawn);
			if (bCanKnockDown)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bCanKnockDown = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ShouldKnockDownOnBump(MyWMPRI.GetSkillUpgrade(index), KFPM, OwnerPawn);
			if (bCanKnockDown)
				return True;
		}
	}
...
simulated function bool ShouldNeverDud()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bCouldExplode = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ShouldNeverDud(MyWMPRI.bPerkUpgrade[index].level, KFW, OwnerPawn);
			if (bCouldExplode)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bCouldExplode = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ShouldNeverDud(MyWMPRI.GetSkillUpgrade(index), KFW, OwnerPawn);
			if (bCouldExplode)
				return True;
		}
	}
...
function bool CouldBeZedShrapnel(class<KFDamageType> KFDT)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bCouldExplode = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.CouldBeZedShrapnel(MyWMPRI.bPerkUpgrade[index].level, KFDT);
			if (bCouldExplode)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bCouldExplode = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.CouldBeZedShrapnel(MyWMPRI.GetSkillUpgrade(index), KFDT);
			if (bCouldExplode)
				return True;
		}
	}
...
simulated function bool ShouldShrapnel()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bShouldExplode = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ShouldShrapnel(MyWMPRI.bPerkUpgrade[index].level);
			if (bShouldExplode)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bShouldExplode = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ShouldShrapnel(MyWMPRI.GetSkillUpgrade(index));
			if (bShouldExplode)
				return True;
		}
	}
...
simulated function bool IsRangeActive()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bRangeActive = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.IsRangeActive(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bRangeActive)
			{
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bRangeActive = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.IsRangeActive(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bRangeActive)
			{
				MyWMPRI.bExtraFireRange = True;
				return True;
...
simulated function bool IsGroundFireActive()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bSplashActive = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.IsGroundFireActive(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bSplashActive)
			{
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bSplashActive = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.IsGroundFireActive(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bSplashActive)
			{
				MyWMPRI.bSplashActive = True;
				return True;
...
simulated function bool GetUsingTactialReload(KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bTacticalReload = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetUsingTactialReload(MyWMPRI.bPerkUpgrade[index].level, KFW);
			if (bTacticalReload)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bTacticalReload = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetUsingTactialReload(MyWMPRI.GetSkillUpgrade(index), KFW);
			if (bTacticalReload)
				return True;
		}
	}
...
simulated function InitiateWeapon(KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.InitiateWeapon(MyWMPRI.bPerkUpgrade[index].level, KFW, OwnerPawn);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.InitiateWeapon(MyWMPRI.GetSkillUpgrade(index), KFW, OwnerPawn);
		}
	}
...
simulated function float GetSelfHealingSurgePct()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetSelfHealingSurgePct(InHealingPct, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetSelfHealingSurgePct(InHealingPct, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
simulated event float GetIronSightSpeedModifier(KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetIronSightSpeedModifier(InSpeed, DefaultSpeed, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetIronSightSpeedModifier(InSpeed, DefaultSpeed, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
simulated event float GetCrouchSpeedModifier(KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetCrouchSpeedModifier(InSpeed, DefaultSpeed, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetCrouchSpeedModifier(InSpeed, DefaultSpeed, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
function simulated SetSuccessfullParry()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.SuccessfullParry(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.SuccessfullParry(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
		}
	}
}
...
function bool CanNotBeGrabbed()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bNoGrab = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.CanNotBeGrabbed(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bNoGrab)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bNoGrab = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.CanNotBeGrabbed(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bNoGrab)
				return True;
		}
	}
...
simulated function bool ShouldRandSirenResist()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bResist = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ProjSirenResist(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bResist)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bResist = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ProjSirenResist(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bResist)
				return True;
		}
	}
...
simulated function bool GetIsUberAmmoActive(KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bUber = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetIsUberAmmoActive(MyWMPRI.bPerkUpgrade[index].level, KFW, OwnerPawn);
			if (bUber)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bUber = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetIsUberAmmoActive(MyWMPRI.GetSkillUpgrade(index), KFW, OwnerPawn);
			if (bUber)
				return True;
		}
	}
...
function HealingDamage(int HealAmount, KFPawn KFP, class<DamageType> DamageType)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.HealingDamage(MyWMPRI.bPerkUpgrade[index].level, HealAmount, KFP, OwnerPawn, DamageType);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.HealingDamage(MyWMPRI.GetSkillUpgrade(index), HealAmount, KFP, OwnerPawn, DamageType);
		}
	}
}
...
simulated event float GetZedTimeModifier(KFWeapon W)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetZedTimeModifier(InModifier, MyWMPRI.bPerkUpgrade[index].level, W);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetZedTimeModifier(InModifier, MyWMPRI.GetSkillUpgrade(index), W);
		}
	}
...
simulated function bool CanSeeEnemyHealth()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bCanSee = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.CanSeeEnemyHealth(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bCanSee)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bCanSee = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.CanSeeEnemyHealth(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bCanSee)
				return True;
		}
	}
...
simulated function bool IsCallOutActive()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bCallOut = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.IsCallOutActive(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bCallOut)
			{
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bCallOut = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.IsCallOutActive(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bCallOut)
			{
				bCanSeeCloakedZeds = True;
				return bCanSeeCloakedZeds;
...
simulated function float GetCloakDetectionRange()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyCloakDetectionRange(InRange, DefaultRange, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyCloakDetectionRange(InRange, DefaultRange, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
simulated function ReceiveLocalizedMessage(class<LocalMessage> Message, optional int Switch)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ReceiveLocalizedMessage(MyWMPRI.bPerkUpgrade[index].level, Message, OwnerPawn, Switch);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ReceiveLocalizedMessage(MyWMPRI.GetSkillUpgrade(index), Message, OwnerPawn, Switch);
		}
	}
}
...
simulated function bool ShouldSacrifice()
{
	...
	if (!bUsedSacrifice)
	{
		if (MyWMPRI != None && MyWMGRI != None)
		{
			...
			{
				index = MyWMPRI.Purchase_PerkUpgrade[i];
				bSacrifice = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ShouldSacrifice(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
				if (bSacrifice)
					return True;
			}
			for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
			...
			{
				index = MyWMPRI.Purchase_SkillUpgrade[i];
				bSacrifice = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ShouldSacrifice(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
				if (bSacrifice)
					return True;
			}
		}
...
simulated function bool DoorShouldNuke()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bTrap = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.DoorShouldNuke(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bTrap)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bTrap = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.DoorShouldNuke(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bTrap)
				return True;
		}
	}
...
simulated function bool CanExplosiveWeld()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bTrap = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.CanExplosiveWeld(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bTrap)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bTrap = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.CanExplosiveWeld(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bTrap)
				return True;
		}
	}
...
simulated function bool IsSupplierActive()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bActive = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.IsSupplierActive(MyWMPRI.bPerkUpgrade[index].level);
			if (bActive)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bActive = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.IsSupplierActive(MyWMPRI.GetSkillUpgrade(index));
			if (bActive)
				return True;
		}
	}
...
simulated function SupplierModifiers(out float PrimaryAmmoPercentage, out float SecondaryAmmoPercentage, out float ArmorPercentage, out int GrenadeAmount)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.SupplierModifiers(MyWMPRI.bPerkUpgrade[index].level, PrimaryAmmoPercentage, SecondaryAmmoPercentage, ArmorPercentage, GrenadeAmount);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.SupplierModifiers(MyWMPRI.GetSkillUpgrade(index), PrimaryAmmoPercentage, SecondaryAmmoPercentage, ArmorPercentage, GrenadeAmount);
		}
	}
...
function WaveEnd(KFPlayerController KFPC)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.WaveEnd(MyWMPRI.bPerkUpgrade[index].level, KFPC);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.WaveEnd(MyWMPRI.GetSkillUpgrade(index), KFPC);
		}
	}
}
...
simulated function DrawSpecialPerkHUD(Canvas C)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.DrawOnHUD(MyWMPRI.bPerkUpgrade[index].level, C, OwnerPawn);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.DrawOnHUD(MyWMPRI.GetSkillUpgrade(index), C, OwnerPawn);
		}
	}
}
...
simulated function byte GetHealingDamageBoost()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetHealingDamageBoost(InHealingDamageBoost, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetHealingDamageBoost(InHealingDamageBoost, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
simulated function byte GetMaxHealingDamageBoost()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetMaxHealingDamageBoost(InMaxHealingDamageBoost, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetMaxHealingDamageBoost(InMaxHealingDamageBoost, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
simulated function byte GetHealingShield()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetHealingShield(InHealingShield, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetHealingShield(InHealingShield, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
simulated function byte GetMaxHealingShield()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetMaxHealingShield(InMaxHealingShield, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetMaxHealingShield(InMaxHealingShield, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
simulated function bool HasNightVision()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bActive = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.HasNightVision(MyWMPRI.bPerkUpgrade[index].level);
			if (bActive)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bActive = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.HasNightVision(MyWMPRI.GetSkillUpgrade(index));
			if (bActive)
				return True;
		}
	}
...
simulated function class<EmitterCameraLensEffectBase> GetPerkLensEffect(class<KFDamageType> DmgType)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetPerkLensEffect(CamEffect, DmgType, MyWMPRI.bPerkUpgrade[index].level);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetPerkLensEffect(CamEffect, DmgType, MyWMPRI.GetSkillUpgrade(index));
		}
	}
...
function bool IsUnAffectedByZedTime()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bActive = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.IsUnAffectedByZedTime(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bActive)
			{
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bActive = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.IsUnAffectedByZedTime(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bActive)
			{
				OwnerPawn.bMovesFastInZedTime = True;
				return True;
...
simulated function ApplyBatteryRechargeRate()
{
	...
	if (CheckOwnerPawn())
	{
		...
		if (MyWMPRI != None && MyWMGRI != None)
		{
			...
			{
				index = MyWMPRI.Purchase_PerkUpgrade[i];
				MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.GetBatteryRateScale(InRechargeRateFL, InRechargeRateNVG, MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			}
			for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
			{
				index = MyWMPRI.Purchase_EquipmentUpgrade[i];
			...
			{
				index = MyWMPRI.Purchase_SkillUpgrade[i];
				MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.GetBatteryRateScale(InRechargeRateFL, InRechargeRateNVG, MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			}
		}
...
simulated function bool ImmuneToCameraShake()
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bActive = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ImmuneToCameraShake(MyWMPRI.bPerkUpgrade[index].level, OwnerPawn);
			if (bActive)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bActive = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ImmuneToCameraShake(MyWMPRI.GetSkillUpgrade(index), OwnerPawn);
			if (bActive)
				return True;
		}
	}
...
simulated function ModifyMaxDeployed(out int CurrentMaxDeployed, KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ModifyMaxDeployed(CurrentMaxDeployed, DefaultMaxDeployed, MyWMPRI.bPerkUpgrade[index].level, KFW);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ModifyMaxDeployed(CurrentMaxDeployed, DefaultMaxDeployed, MyWMPRI.GetSkillUpgrade(index), KFW);
		}
	}
}
...
simulated function bool CanSeeCloaked(KFWeapon KFW)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bSeeCloaked = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.CanSeeCloaked(MyWMPRI.bPerkUpgrade[index].level, KFW, OwnerPawn);
			if (bSeeCloaked)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bSeeCloaked = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.CanSeeCloaked(MyWMPRI.GetSkillUpgrade(index), KFW, OwnerPawn);
			if (bSeeCloaked)
				return True;
		}
	}
...
simulated function bool ExtensionFuncBoolean(string Identifier, optional int InputInt = INDEX_NONE, optional float InputFloat = INDEX_NONE, optional name InputClassName, optional Object InputObject1, optional Object InputObject2, optional Object InputObject3)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			bActive = MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ExtensionFuncBoolean(MyWMPRI.bPerkUpgrade[index].level, Identifier, MyKFW, OwnerPawn, InputInt, InputFloat, InputClassName, InputObject1, InputObject2, InputObject3);
			if (bActive)
				return True;
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			bActive = MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ExtensionFuncBoolean(MyWMPRI.GetSkillUpgrade(index), Identifier, MyKFW, OwnerPawn, InputInt, InputFloat, InputClassName, InputObject1, InputObject2, InputObject3);
			if (bActive)
				return True;
		}
	}
...
simulated function int ExtensionFuncInteger(int DefaultValueIn, string Identifier, optional int InputInt = INDEX_NONE, optional float InputFloat = INDEX_NONE, optional name InputClassName, optional Object InputObject1, optional Object InputObject2, optional Object InputObject3)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ExtensionFuncInteger(InValue, DefaultValue, MyWMPRI.bPerkUpgrade[index].level, Identifier, MyKFW, OwnerPawn, InputInt, InputFloat, InputClassName, InputObject1, InputObject2, InputObject3);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ExtensionFuncInteger(InValue, DefaultValue, MyWMPRI.GetSkillUpgrade(index), Identifier, MyKFW, OwnerPawn, InputInt, InputFloat, InputClassName, InputObject1, InputObject2, InputObject3);
		}
	}
...
simulated function float ExtensionFuncFloat(float DefaultValueIn, string Identifier, optional int InputInt = INDEX_NONE, optional float InputFloat = INDEX_NONE, optional name InputClassName, optional Object InputObject1, optional Object InputObject2, optional Object InputObject3)
{
	...
	if (MyWMPRI != None && MyWMGRI != None)
	{
		...
		{
			index = MyWMPRI.Purchase_PerkUpgrade[i];
			MyWMGRI.PerkUpgradesList[index].PerkUpgrade.static.ExtensionFuncFloat(InValue, DefaultValue, MyWMPRI.bPerkUpgrade[index].level, Identifier, MyKFW, OwnerPawn, InputInt, InputFloat, InputClassName, InputObject1, InputObject2, InputObject3);
		}
		for (i = 0; i < MyWMPRI.Purchase_EquipmentUpgrade.Length; ++i)
		{
			index = MyWMPRI.Purchase_EquipmentUpgrade[i];
		...
		{
			index = MyWMPRI.Purchase_SkillUpgrade[i];
			MyWMGRI.SkillUpgradesList[index].SkillUpgrade.static.ExtensionFuncFloat(InValue, DefaultValue, MyWMPRI.GetSkillUpgrade(index), Identifier, MyKFW, OwnerPawn, InputInt, InputFloat, InputClassName, InputObject1, InputObject2, InputObject3);
		}
	}
